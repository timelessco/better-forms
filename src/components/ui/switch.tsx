...
export const Switch = ({
  ...
  >
    <SwitchPrimitive.Thumb
      ...
      className="pointer-events-none block rounded-full bg-background shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-1px_rgba(0,0,0,0.06)] ring-0 transition-transform duration-200 ease-[cubic-bezier(0.34,1.45,0.7,1)] group-data-[size=default]/switch:size-3 group-data-[size=sm]/switch:size-3 group-data-[size=default]/switch:data-checked:translate-x-[11px] group-data-[size=sm]/switch:data-checked:translate-x-[calc(100%-2px)] dark:data-checked:bg-primary-foreground group-data-[size=default]/switch:data-unchecked:translate-x-px group-data-[size=sm]/switch:data-unchecked:translate-x-0 dark:data-unchecked:bg-background"
    />
  </SwitchPrimitive.Root>
);
